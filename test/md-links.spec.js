...
describe('mdLinks', () => {
    describe('Leyendo archivos', () => {
        test('Deberia retornar el objeto con el file, href y text', async (done) => {
            await expect
            mdLinks('/home/laboratoria/Desktop/SCL009-md-links/test/prueba.md', []).then(data => {
        ...
        test('Deberia retornar el objeto con el file, href, text,  status, statusText', async (done) => {
            await expect
            mdLinks('/home/laboratoria/Desktop/SCL009-md-links/test/prueba.md', [{ validate: true }]).then(data => {
                expect(data).toStrictEqual([{
                    file: 'prueba.md',
                    href: 'https://nodejs.org/es/about/',
                    text: 'Acerca de Node.js - Documentación oficial',
        ...
        test('Deberia retornar el objeto con el total de links y los links unicos', async (done) => {
            await expect
            mdLinks('/home/laboratoria/Desktop/SCL009-md-links/test/prueba.md', [{ stats: true }]).then(data => {
        ...
        test('Deberia retornar el objeto con  el total de links y los links unicos y los rotos', async (done) => {
           await expect
            mdLinks('/home/laboratoria/Desktop/SCL009-md-links/test/prueba.md', [{ stats: true }, { validate: true }]).then(data => {
        ...
        test('Deberia retornar el objeto con el total de links y los links unicos y los rotos', async (done) => {
           await expect
            mdLinks('/home/laboratoria/Desktop/SCL009-md-links/test/prueba.md', [{ validate: true }, { stats: true }]).then(data => {
                expect(data).toStrictEqual({ Total: 5, Unique: 3, Broken: 3 }); done();
            });
        });
    });
    ...
    describe('Leyendo Directorios', () => {
        test('Deberia retornar el objeto con el href, file y text', async (done) => {
            await expect
            mdLinks('/home/laboratoria/Desktop/SCL009-md-links/test', []).then(data => {
                expect(data).toStrictEqual([{
                    file: 'directorio.md',
        ...
        test('Deberia retornar el objeto con el href, text, file, status, statusText', async (done) => {
            await expect
            mdLinks('/home/laboratoria/Desktop/SCL009-md-links/test', [{ validate: true }]).then(data => {
                expect(data).toStrictEqual([{
                    file: 'directorio.md',
                    href: 'https://es.wikipedia.org/wiki/Markdown',
                    text: 'Markdown',
        ...
        test('Deberia retornar el objeto con el total de links y los links unicos', async (done) => {
            await expect
            mdLinks('/home/laboratoria/Desktop/SCL009-md-links/test', [{ stats: true }]).then(data => {
        ...
        test('Deberia retornar el objeto con  el total de links y los links unicos y los rotos', async (done) => {
           await expect
            mdLinks('/home/laboratoria/Desktop/SCL009-md-links/test', [{ stats: true }, { validate: true }]).then(data => {
        ...
        test('Deberia retornar el objeto con el total de links y los links unicos y los rotos', async (done) => {
            await expect
            mdLinks('/home/laboratoria/Desktop/SCL009-md-links/test', [{ validate: true }, { stats: true }]).then(data => {
                expect(data).toStrictEqual({ Total: 10, Unique: 8, Broken: 3 }); done();
            });
        });
